...
************************************************/
OMCSChat.ConnectionManager = (function () {
    var _signaler,
        _connections = {},
        ...
        _createConnection = function (partnerClientId) {
            console.log('WebRTC: creating connection... with partnerClientId = ' + partnerClientId);
            ...
            connection.onicecandidate = function (event) {
                if (event.candidate) {
                    ...
                    console.log("sendSignal: " + JSON.stringify({ "candidate": event.candidate }));
